  ...
  return (
      <motion.div
          ...
          <motion.img
              ...
              viewport={{once: true}}
              src="https://64.media.tumblr.com/231ef78e6ab904b2466e5d32a0042678/c67a070feb43747a-93/s512x512u_c1/763284787fae8b8aaf5bf6dc62980e22bc6bb752.jpg"
              className='-mb-50 md:mb-0 flex-shrink-0 w-72 h-72 rounded-full object-cover md:rounded-lg md:w-64 h-96 xl:w-[500px] xl:h-[600px] border border-[#F7AB0A] '
          />
          <motion.div
              className='space-y-10 px-0 md:p-10'>
              <h4 className='text-4xl font-semibold uppercase'>SOMEWHAT <span className='text-[#F7AB0A]'>ABOUT</span> ME</h4>
              <p className='text-base relative t-40'>
